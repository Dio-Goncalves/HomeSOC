...
**Observations:** 
 ...
 - Also, due to the limited available time, the usernames present in the screenshots are not redacted. I'm aware that its a bad practice but considering that the lab is no longer live, its rather irrelevant. It's perfectly fine for demonstration purposes;
